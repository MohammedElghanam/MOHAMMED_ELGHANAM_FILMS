...
export default function Login () {
    ...
    const { popup, showPopup, closePopup, goToRegister } = useLogin();
            ...
            <div className=" bg-white p-5 lg:p-10 rounded-lg">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className=" flex justify-between items-center mb-2">
                        ...
                        <p onClick={ showPopup } className=" text-xs lg:text-sm underline text-blue-700 cursor-pointer">forgot password</p>
                    </div>
                    <div className="">
                    ...
                    <div className=" flex justify-center items-center mt-6">
                        ...
                        <a onClick={ goToRegister } className=" text-blue-500" href=""> Create an account</a></p>
                    </div>
                </form>
            </div>
        </div>
