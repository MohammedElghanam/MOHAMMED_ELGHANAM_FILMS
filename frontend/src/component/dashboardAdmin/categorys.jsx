    ...
    return <>
        <div className=" col-span-4 h-fit bg-white shadow-2xl rounded-xl py-4">
            <div className=" flex justify-between items-center px-4 border-b pb-2">
                ...
                <button onClick={ mountCategoryPopup } className=" py-1.5 px-2 rounded-lg font-medium text-white bg-purple-600 hover:bg-purple-500"> 
                    <i className="fa-solid fa-layer-group fa-sm" style={{color: '#ffffff'}}></i>
                </button>                            
            </div>
            <div className=" flex gap-2 w-full mt-2 px-4">
                <div className=" flex justify-center items-center gap-3 w-fit px-2 py-2 border-[1.5px] border-blue-500 bg-white rounded-lg">
